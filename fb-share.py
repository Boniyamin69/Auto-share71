...
def logo_menu():
 ...
 cetak(nel(banner,title=f'{P2} {K2}[ {H2}Y{H2}A{H2}M{H2}I{H2}N {B2}A{B2}U{B2}T{B2}O {K2}S{K2}H{K2}A{K2}R{K2}E {H2}]',subtitle_align='left',padding=1,style='blue'))
	
###----------[ LOGIN MINU ]----------###	
def login():
	os.system("clear")
	cetak(nel(f'\n \t {H2}  FB AUTO SHARE TOOLS BRO \n\n \t\t {H2}~[{K2} Y{K2}A{K2}M{K2}I{K2}N {H2}]~',title=f'{P2}  {H2}[{K2} Y{K2}A{K2}M{K2}I{K2}N {K2}T{K2}E{K2}R{K2}M{K2}U{K2}X {K2}H{K2}E{K2}L{K2}P{K2}I{K2}N{K2}G {K2}Z{K2}O{K2}N{K2}E {H2}]', width=54,padding=(1,4),style='blue'))
...
{B2} Current Date    :{H2} {hari}, {tanggal}''',title=f'{P2} {H2}[ {K2}Cookie Id Information {H2}]',subtitle_align='left',padding=1,style='blue'))
	...
	cetak(nel(f'{H2} Y{H2}A{H2}M{H2}I{H2}N {B2}F{B2}B {O2}A{O2}U{O2}T{O2}O {N2}S{N2}H{N2}A{N2}R{N2}E {K2}S{K2}T{K2}A{K2}R{K2}T',subtitle=f'{P2}┌─',subtitle_align='left',width=29,padding=0,style='blue'))
	...
	try:
		...
		for x in range(jumlah):
			...
			if "id" in post:
				...
				print(f'{P}\r   └──>{H} {bas} {K} Y{K}A{K}M{K}I{K}N SEND {H}[{n}]{P}{K} AUTO SHARE {H} SUCSSES{H} ',end='');sys.stdout.flush()
			else:
				print("\n")
